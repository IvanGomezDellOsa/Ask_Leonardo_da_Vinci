...
const L = [
  ...
  "",
  "Para cada caso: partir la respuesta en afirmaciones y etiquetar `F` / `N` / `X`",
  "(la `C` de la v1 se pliega dentro de `F`, ver rubrica v2 §2).",
  "",
  "**El atajo de la v2:** una afirmacion solo es `N` si tiene un ELEMENTO DURO ausente",
  "de los pasajes — nombre propio, fecha, numero, mecanismo causal, o algo posterior",
  "a 1519. Si no tiene ninguno de esos cinco, es `X` y no hay que deliberar. No es un",
  "juicio, es una busqueda.",
  "",
  "**Lo que va entre `«»` no se anota**: su fidelidad la mide `npm run evals:citas`",
  "por comparacion de texto. Se anota lo que Leonardo dice ALREDEDOR de la cita. La",
  "unica excepcion: si lo citado no aparece en ningun pasaje, eso es `N` y de las graves.",
  "",
  "Veredicto del caso: `alucina` = tiene al menos una `N`.",
  "",
  "---",
  "",
];
